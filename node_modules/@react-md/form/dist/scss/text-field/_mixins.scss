...
@mixin rmd-text-field-container {
  ...
  &--error {
    ...
    @include rmd-form-theme-update-var(text-active-color, rmd-form-theme-var(error-color));
    @include rmd-form-theme-update-var(text-border-color, rmd-form-theme-var(error-color));
  ...
  &--disabled {
    @include rmd-icon-theme-update-var(color, rmd-form-theme-var(disabled-color));
  }
  ...
  &--underline-labelled {
    ...
    @include rmd-form-theme-update-var(addon-margin-top, $rmd-text-field-addon-margin);
  }
  ...
  &--underline-right-addon {
    ...
    @include rmd-form-theme-update-var(text-padding-right, calc(#{$calc-string}));
  }
  ...
  &--outline-right {
    $outline-offset: calc(#{rmd-icon-theme-var(size)} + #{$rmd-text-field-addon-margin * 2});
...
@mixin rmd-textarea-container {
  ...
  max-width: 100%;
  padding-top: calc(
    #{rmd-form-theme-var(text-padding-top)} + #{rmd-form-theme-var(textarea-padding)}
  );
...
@mixin rmd-password {
  ...
  &__input {
    &--offset {
      @include rmd-utils-rtl-auto(margin-right, rmd-button-theme-var(icon-size));
    }
  }
...
@mixin rmd-form-message {
  ...
  &__counter {
    ...
    @include rmd-utils-rtl-auto(padding-left, $rmd-form-message-counter-spacing);
