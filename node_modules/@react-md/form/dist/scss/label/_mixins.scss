...
@mixin rmd-floating-label {
  @include rmd-form-theme-update-var(active-color, rmd-form-theme-var(text-active-color));
  ...
  position: absolute;
  top: 0;
  transform: translate(rmd-form-theme-var(text-padding-left), rmd-form-theme-var(floating-top));
  transition-property: $transitions;
  will-change: $transitions;

  &--dense {
    @include rmd-form-theme-update-var(floating-top, rmd-form-theme-var(floating-dense-top));
  }
