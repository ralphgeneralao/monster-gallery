 ...
 */
export interface ProvidedIndeterminateControlledCheckboxProps<T extends string> {
    value: T;
    checked: boolean;
    onChange: () => void;
}
 ...
 */
export declare type GetIndeterminateControlledCheckboxProps<T extends string> = (value: T) => ProvidedIndeterminateControlledCheckboxProps<T>;
 ...
 */
export default function useIndeterminateChecked<T extends string>(values: T[], defaultCheckedValues?: T[] | (() => T[]), onChange?: (checkedValues: T[]) => void): IndeterminateCheckedReturnValue<T>;
