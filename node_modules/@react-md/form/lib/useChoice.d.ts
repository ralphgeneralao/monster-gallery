 ...
 */
export default function useChoice<T extends DefaultValue = DefaultValue, E extends InputElement = InputElement>(defaultValue: T, onChange?: ChangeEventHandler<E>): [T, ChangeEventHandler<E>, SetValue<T>];
export {};
