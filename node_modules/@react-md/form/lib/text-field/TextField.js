...
var block = utils_1.bem("rmd-text-field");
var SPECIAL_TYPES = [
    "date",
    "time",
    "datetime-local",
 ...
 */
var TextField = react_1.forwardRef(function TextField(_a, ref) {
    ...
    var _j = useFocusState_1.default({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    }), focused = _j[0], onFocus = _j[1], onBlur = _j[2];
    var _k = useValuedState_1.default({
        value: value,
        defaultValue: defaultValue,
        onChange: propOnChange,
    }), valued = _k[0], onChange = _k[1];
    var _l = FormThemeProvider_1.useFormTheme({
        theme: propTheme,
    ...
    return (react_1.default.createElement(TextFieldContainer_1.default, __assign({}, containerProps, { style: style, className: className, ref: containerRef, theme: theme, error: error, active: focused, label: !!label, dense: dense, inline: inline, disabled: disabled, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, leftChildren: leftChildren, rightChildren: rightChildren, underlineDirection: underlineDirection }),
        react_1.default.createElement(FloatingLabel_1.default, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, active: focused, floating: focused || valued || SPECIAL_TYPES.includes(type), valued: valued, dense: dense, disabled: disabled }, label),
        react_1.default.createElement("input", __assign({}, props, { ref: ref, type: type, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange, style: inputStyle, className: classnames_1.default(block({
