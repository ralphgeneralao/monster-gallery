...
var block = utils_1.bem("rmd-text-field-addon");
/**
 * This component is used to add an an icon before or after the text field with
 * correct styling.
 */
var TextFieldAddon = react_1.forwardRef(function TextFieldAddon(_a, ref) {
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: classnames_1.default(block({ presentational: presentational }), className) }), children));
});
...
exports.default = TextFieldAddon;
