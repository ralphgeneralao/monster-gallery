...
var TextFieldAddon_1 = __importDefault(require("./TextFieldAddon"));
 ...
 */
var TextFieldContainer = react_1.forwardRef(function TextFieldContainer(_a, ref) {
    var _b;
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: classnames_1.default(block((_b = {
            ...
            _b)), className) }),
        isLeftAddon ? (react_1.default.createElement(TextFieldAddon_1.default, null, leftChildren)) : (leftChildren),
        children,
        isRightAddon ? (react_1.default.createElement(TextFieldAddon_1.default, null, rightChildren)) : (rightChildren)));
});
