 ...
 */
var Password = react_1.forwardRef(function Password(_a, ref) {
    ...
    var id = props.id;
    var _d = react_1.useState("password"), type = _d[0], setType = _d[1];
    ...
    return (react_1.default.createElement(TextField_1.default, __assign({}, props, { className: classnames_1.default(block({ offset: !disableVisibility }), className), inputClassName: classnames_1.default(block("input", { offset: !disableVisibility }), inputClassName), ref: ref, type: type, isRightAddon: false, rightChildren: !disableVisibility && (react_1.default.createElement(button_1.Button, { id: id + "-password-toggle", "aria-label": visibilityLabel, "aria-pressed": visible, buttonType: "icon", onClick: toggle, style: visibilityStyle, className: classnames_1.default(block("toggle"), visibilityClassName) }, typeof getVisibilityIcon === "function"
