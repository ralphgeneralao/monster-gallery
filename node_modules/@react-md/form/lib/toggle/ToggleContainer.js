...
var block = utils_1.bem("rmd-toggle-container");
/**
 ...
 */
var ToggleContainer = react_1.forwardRef(function ToggleContainer(_a, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: classnames_1.default(block({ stacked: stacked, inline: inline }), className) }), children));
});
