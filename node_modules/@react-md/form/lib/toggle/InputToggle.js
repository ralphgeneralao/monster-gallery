...
var InputToggle = react_1.forwardRef(function InputToggle(allProps, ref) {
    ...
    var labelEl = (react_1.default.createElement(Label_1.default, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, disabled: typeof labelDisabled === "boolean" ? labelDisabled : disabled }, label));
    return (react_1.default.createElement(ToggleContainer_1.default, { style: style, className: className, inline: inline, stacked: stacked },
        iconAfter && labelEl,
