 ...
 */
var AsyncSwitch = react_1.forwardRef(function AsyncSwitch(_a, ref) {
    ...
    return (react_1.default.createElement(Switch_1.default, __assign({}, props, progress_1.getProgressA11y(progressId, loading), { id: id, ref: ref, disabled: disabled, className: classnames_1.default("rmd-switch--async", className), labelDisabled: disabled || false, onChange: loading ? noop : onChange }), loading && (react_1.default.createElement(progress_1.CircularProgress, { id: progressId, style: progressStyle, className: classnames_1.default("rmd-switch__progress", progressClassName), centered: false }))));
});
