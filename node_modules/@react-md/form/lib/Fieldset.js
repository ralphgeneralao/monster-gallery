...
var block = utils_1.bem("rmd-fieldset");
/**
 ...
 */
var Fieldset = react_1.forwardRef(function Fieldset(_a, ref) {
    ...
    return (react_1.default.createElement("fieldset", __assign({}, props, { ref: ref, className: classnames_1.default(block({ unstyled: unstyled }), className) }),
        react_1.default.createElement("legend", { style: legendStyle, className: classnames_1.default(block("legend", { "sr-only": legendSROnly }), legendClassName) }, legend),
        children));
});
