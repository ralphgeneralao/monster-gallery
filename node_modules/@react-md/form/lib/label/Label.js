...
var block = utils_1.bem("rmd-label");
/**
 ...
 */
var Label = react_1.forwardRef(function Label(_a, ref) {
    ...
    return (react_1.default.createElement(Component, __assign({}, props, { ref: ref, className: classnames_1.default(block({
            error: error,
            active: active,
            disabled: disabled,
        }), className), htmlFor: Component === "label" ? htmlFor : undefined }), children));
});
