...
import { ProvidedTreeItemProps, ProvidedTreeProps, BaseTreeItem } from "./types";
/**
 ...
 */
export default function defaultTreeItemRenderer(itemProps: ProvidedTreeItemProps, item: BaseTreeItem & {
    visibleIndex: number;
