 ...
 */
export default function getChildItems<T extends BaseTreeItem = UnknownTreeItem>(data: TreeData<T> | readonly T[], parentId: TreeItemId | null, recursive?: boolean): readonly T[];
