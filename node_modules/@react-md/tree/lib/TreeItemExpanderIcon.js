...
function TreeItemExpanderIcon(_a) {
    ...
    var icon = icon_1.useIcon("expander", children);
    return (react_1.default.createElement(icon_1.IconRotator, __assign({}, props, { rotated: rotated, className: classnames_1.default(block("rotator-icon"), className) }), icon));
}
exports.default = TreeItemExpanderIcon;
