...
var useFlattenedTreeList_1 = __importDefault(require("./useFlattenedTreeList"));
var useNestedTreeList_1 = __importDefault(require("./useNestedTreeList"));
/**
...
function useTreeMovement(_a) {
    ...
    var items = useNestedTreeList_1.default(data, sort, rootId);
    var _b = useFlattenedTreeList_1.default({
        id: id,
        items: items,
    ...
    var _c = utils_1.useActiveDescendantMovement(__assign(__assign({}, utils_1.MovementPresets.VERTICAL_TREE), { items: visibleItems, baseId: id, getId: function (_baseId, index) {
        ...
        onChange: function (data) {
            ...
            if (item && target && target.scrollHeight > target.offsetHeight) {
                utils_1.scrollIntoView(target, item);
            }
            if (!multiSelect) {
                return;
            }
    ...
    var handleFocus = react_1.useCallback(function (event) {
        ...
        if (currentItem && isKeyboard) {
            utils_1.scrollIntoView(event.currentTarget, currentItem);
        }
...
exports.default = useTreeMovement;
