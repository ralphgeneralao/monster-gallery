...
var defaultGetItemLabel_1 = __importDefault(require("./defaultGetItemLabel"));
var defaultGetItemValue_1 = __importDefault(require("./defaultGetItemValue"));
var defaultTreeItemRenderer_1 = __importDefault(require("./defaultTreeItemRenderer"));
var useTreeMovement_1 = __importDefault(require("./useTreeMovement"));
 ...
 */
var Tree = react_1.forwardRef(function Tree(// eslint-disable-line @typescript-eslint/no-explicit-any
_a, ref) {
    var id = _a.id, className = _a.className, _b = _a.itemRenderer, itemRenderer = _b === void 0 ? defaultTreeItemRenderer_1.default : _b, data = _a.data, _c = _a.multiSelect, multiSelect = _c === void 0 ? false : _c, selectedIds = _a.selectedIds, onItemSelect = _a.onItemSelect, onMultiItemSelect = _a.onMultiItemSelect, expandedIds = _a.expandedIds, onItemExpansion = _a.onItemExpansion, onMultiItemExpansion = _a.onMultiItemExpansion, _d = _a.expanderLeft, expanderLeft = _d === void 0 ? false : _d, propExpanderIcon = _a.expanderIcon, _e = _a.labelKey, labelKey = _e === void 0 ? "name" : _e, _f = _a.valueKey, valueKey = _f === void 0 ? "name" : _f, _g = _a.getItemLabel, getItemLabel = _g === void 0 ? defaultGetItemLabel_1.default : _g, _h = _a.getItemValue, getItemValue = _h === void 0 ? defaultGetItemValue_1.default : _h, _j = _a.getItemProps, getItemProps = _j === void 0 ? defaultGetItemProps : _j, linkComponent = _a.linkComponent, sort = _a.sort, _k = _a.rootId, rootId = _k === void 0 ? null : _k, onBlur = _a.onBlur, onFocus = _a.onFocus, onKeyDown = _a.onKeyDown, props = __rest(_a, // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    var _l = useTreeMovement_1.default({
        id: id,
        data: data,
        sort: sort,
        rootId: rootId,
        ...
        return items.map(function (item, index) {
            ...
            return itemRenderer({
                ...
                renderChildItems: childItems
                    ? function () {
                        return renderChildItems(childItems, depth + 1, __spreadArrays(parentIndexes, [
                            index + 1,
                        ]));
                    }
                    : undefined,
