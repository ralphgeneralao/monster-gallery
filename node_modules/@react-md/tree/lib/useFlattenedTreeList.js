...
var getTreeItemId_1 = __importDefault(require("./getTreeItemId"));
function flatten(_a) {
    ...
    var id = getTreeItemId_1.default(baseId, index, parentIndexes);
...
exports.default = useFlattenedTreeList;
