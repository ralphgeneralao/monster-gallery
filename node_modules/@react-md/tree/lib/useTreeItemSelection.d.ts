import { SelectedIds, TreeItemSelection } from "./types";
/**
 ...
 */
export default function useTreeItemSelection(defaultSelectedIds: SelectedIds | (() => SelectedIds), multiSelect?: boolean): Required<TreeItemSelection>;
