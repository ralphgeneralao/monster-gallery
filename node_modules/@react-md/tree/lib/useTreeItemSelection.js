...
function useTreeItemSelection(defaultSelectedIds, multiSelect) {
    ...
    var _a = react_1.useState(defaultSelectedIds), selectedIds = _a[0], setSelectedIds = _a[1];
    var onItemSelect = react_1.useCallback(function (itemId) {
    ...
    var onMultiItemSelect = react_1.useCallback(function (itemIds) {
...
exports.default = useTreeItemSelection;
