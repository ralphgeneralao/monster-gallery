 ...
 * @private
 */
export default function useTreeMovement({ id, data, rootId, sort, onBlur, onFocus, onKeyDown, multiSelect, selectedIds, onItemSelect, onMultiItemSelect, expandedIds, onItemExpansion, onMultiItemExpansion, valueKey, getItemValue, }: Options): ReturnValue;
export {};
