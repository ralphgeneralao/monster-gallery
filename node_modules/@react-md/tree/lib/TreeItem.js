...
var TreeGroup_1 = __importDefault(require("./TreeGroup"));
var TreeItemExpanderIcon_1 = __importDefault(require("./TreeItemExpanderIcon"));
 ...
 */
var TreeItem = react_1.forwardRef(function TreeItem(_a, ref) {
    var _b;
    ...
    if (renderChildItems) {
        var icon = (react_1.default.createElement(TreeItemExpanderIcon_1.default, { rotated: expanded }, expanderIcon));
        if (expanderLeft) {
            leftAddon = icon;
        }
        else {
        ...
        group = react_1.default.createElement(TreeGroup_1.default, { collapsed: !expanded }, renderChildItems());
    }
