...
var block = utils_1.bem("rmd-sheet");
/**
 ...
 */
var Sheet = react_1.forwardRef(function Sheet(_a, ref) {
    var _b;
    ...
    var offscreen = react_1.useRef(!visible && !unmountOnExit && !mountOnEnter);
    ...
    var _0 = react_1.useState(!visible && !mountOnEnter), hidden = _0[0], setHidden = _0[1];
    if (hidden && visible) {
        setHidden(false);
    }
    ...
    return (react_1.default.createElement(dialog_1.Dialog, __assign({}, props, { ref: ref, type: "custom", role: role, visible: visible, className: classnames_1.default(block((_b = {
