...
@mixin rmd-chip {
  ...
  @include rmd-states-surface($no-focus-state: $rmd-chip-disable-focus-background-color);
  ...
  @if mixin-exists(rmd-progress-theme-update-var) {
    @include rmd-progress-theme-update-var(circular-size, $rmd-chip-progress-size);
    @include rmd-progress-theme-update-var(circular-width, $rmd-chip-progress-width);
  }
