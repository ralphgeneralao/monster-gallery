...
var block = utils_1.bem("rmd-chip");
/**
 ...
 */
var Chip = react_1.forwardRef(function Chip(_a, ref) {
    var _b;
    ...
    var _j = states_1.useInteractionStates({
        handlers: props,
    ...
    if (!disableContentWrap) {
        content = (react_1.default.createElement("span", { style: contentStyle, className: classnames_1.default(block("content"), contentClassName) }, children));
    }
    var leftIcon = propLeftIcon;
    var selectable = typeof selected === "boolean";
    var selectedIcon = icon_1.useIcon("selected", propSelectedIcon);
    ...
    if (selectable &&
        ...
        if (!disableIconTransition && react_1.isValidElement(selectedIcon)) {
            isHiddenIcon = !selected;
            leftIcon = react_1.cloneElement(selectedIcon, {
    ...
    return (react_1.default.createElement("button", __assign({}, props, handlers, { ref: ref, "aria-pressed": ariaPressed !== null && ariaPressed !== void 0 ? ariaPressed : (!!selected || undefined), type: "button", className: classnames_1.default(block((_b = {},
            _b[theme] = true,
