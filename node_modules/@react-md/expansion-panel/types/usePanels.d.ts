...
declare type ReturnValue = [ProvidedPanelProps[], ExpansionPanelKeyDownHandler, ExpandedIds, ExpansionDispatcher, CreateExpandById];
/**
 ...
 * ```
 */
export default function usePanels({ idPrefix, count, multiple, preventAllClosed, defaultExpandedIndex, }: UsePanelsOptions): ReturnValue;
export {};
