...
var ExpansionPanelHeader_1 = __importDefault(require("./ExpansionPanelHeader"));
 ...
 */
var ExpansionPanel = react_1.forwardRef(function ExpansionPanel(_a, ref) {
    ...
    return (react_1.default.createElement(card_1.Card, __assign({}, props, { id: id + "-container", ref: ref, fullWidth: fullWidth, className: classnames_1.default(block({ expanded: expanded, "margin-top": marginTop }), className) }),
        customHeader || (react_1.default.createElement(ExpansionPanelHeader_1.default, { "aria-disabled": disabled || undefined, id: id, ref: headerRef, style: headerStyle, className: headerClassName, icon: expanderIcon, expanded: expanded, onClick: onExpandClick, disableTransition: disableTransition }, header)),
