...
/// when `null`.
@mixin rmd-expansion-panel-theme($property, $theme-style: $property, $fallback: null) {
...
@mixin react-md-expansion-panel {
  @include rmd-theme-create-root-theme($rmd-expansion-panel-theme-values, expansion-panel);
