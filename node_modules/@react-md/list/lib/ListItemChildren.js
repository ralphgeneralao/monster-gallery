...
var ListItemAddon_1 = __importDefault(require("./ListItemAddon"));
...
function ListItemChildren(_a) {
    ...
    if (primaryText || secondaryText || textChildren) {
        children = (react_1.default.createElement(ListItemText_1.default, { className: textClassName, secondaryText: secondaryText, secondaryTextClassName: secondaryTextClassName }, (textChildren && children) || primaryText));
    }
    children = (react_1.default.createElement(ListItemAddon_1.default, { addon: leftAddon, type: leftAddonType, position: leftAddonPosition, forceAddonWrap: forceAddonWrap }, children));
    children = (react_1.default.createElement(ListItemAddon_1.default, { addon: rightAddon, addonAfter: true, type: rightAddonType, position: rightAddonPosition, forceAddonWrap: forceAddonWrap }, children));
    return (react_1.default.createElement(react_1.default.Fragment, null,
        children,
        (primaryText && stringifiedChildren) || null));
}
exports.default = ListItemChildren;
