 ...
 */
declare function ListItemAddon({ className, children, addon, addonAfter, type, position, forceAddonWrap, ...props }: ListItemAddonProps): ReactElement;
declare namespace ListItemAddon {
    var propTypes: {
        className: any;
        children: any;
        addon: any;
