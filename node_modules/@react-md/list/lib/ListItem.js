...
var SimpleListItem_1 = __importDefault(require("./SimpleListItem"));
/**
 ...
 */
var ListItem = react_1.forwardRef(function ListItem(_a, ref) {
    ...
    return (react_1.default.createElement(SimpleListItem_1.default, __assign({}, props, handlers, { ref: ref, tabIndex: tabIndex, role: role, className: className, clickable: true, height: height }),
