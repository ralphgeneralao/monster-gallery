 ...
 */
declare function ListItemChildren({ textClassName, secondaryTextClassName, textChildren, primaryText, secondaryText, leftAddon, leftAddonType, leftAddonPosition, rightAddon, rightAddonType, rightAddonPosition, forceAddonWrap, children: propChildren, }: ListItemChildrenProps): ReactElement;
declare namespace ListItemChildren {
    var propTypes: {
        textClassName: any;
