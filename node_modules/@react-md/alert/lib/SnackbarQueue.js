...
function SnackbarQueue(_a, ref) {
    ...
    if (toast) {
        ...
        content = (react_1.default.createElement(Toast_1.default, __assign({}, toastProps, { action: action, visible: visible, onEntered: disableAutohide ? undefined : startTimer, onExited: popMessage })));
    }
    return (react_1.default.createElement(Snackbar_1.default, __assign({}, props, { ref: ref }), content));
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
exports.default = react_1.forwardRef(SnackbarQueue);
