...
@mixin rmd-alert-theme($property, $theme-style: $property, $fallback: null) {
  @include rmd-theme-apply-rmd-var($property, $theme-style, $rmd-alert-theme-values, alert);
}
...
@mixin rmd-alert-theme-update-var($theme-style, $value) {
  @include rmd-theme-update-rmd-var($value, $theme-style, $rmd-alert-theme-values, alert);
}
...
@mixin rmd-toast {
  ...
  &--action {
    @include rmd-utils-rtl-auto(padding-right, 0, $rmd-toast-horizontal-padding);
  }
  ...
  &--enter {
    ...
    opacity: 0;
    transform: scale(0);
    transition: opacity $rmd-toast-enter-duration, transform $rmd-toast-enter-duration;
  }
  ...
  &--exit-active {
    opacity: 0;
    transform: scale(0);
    transition: opacity $rmd-toast-exit-duration, transform $rmd-toast-exit-duration;
  }
  ...
  &__message {
    ...
    &--action {
      @include rmd-utils-rtl-auto(padding-right, $rmd-toast-horizontal-padding, 0);
    }
