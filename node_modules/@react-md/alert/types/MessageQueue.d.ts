 ...
 */
declare function MessageQueue<M extends ToastMessage = ToastMessage>({ timeout, duplicates, defaultQueue, children, ...props }: MessageQueueProps<M>): ReactElement;
declare namespace MessageQueue {
    var propTypes: {
        timeout: any;
        duplicates: any;
        defaultQueue: any;
