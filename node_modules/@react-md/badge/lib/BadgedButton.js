 ...
 * notifications.
 */
var BadgedButton = react_1.forwardRef(function BadgedButton(_a, ref) {
    ...
    if (!isEmpty_1.default(children, disableNullOnZero)) {
    ...
    return (react_1.default.createElement(button_1.Button, __assign({}, props, { "aria-label": ariaLabel, "aria-describedby": describedBy, ref: ref, buttonType: buttonType }),
        buttonChildren,
        react_1.default.createElement(Badge_1.default, { id: badgeId, ref: badgeRef, theme: badgeTheme, style: badgeStyle, className: badgeClassName, disableNullOnZero: disableNullOnZero }, children)));
});
