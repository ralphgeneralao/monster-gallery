...
var block = utils_1.bem("rmd-badge");
/**
 ...
 */
var Badge = react_1.forwardRef(function Badge(_a, ref) {
    var _b;
    ...
    return (react_1.default.createElement("span", __assign({}, props, { ref: ref, className: classnames_1.default(block((_b = {}, _b[theme] = theme !== "clear", _b)), className) }), children));
});
