 ...
 */
var SkipToMainContent = react_1.forwardRef(function SkipToMainContent(_a, ref) {
    ...
    return (react_1.default.createElement(Link_1.default, __assign({}, props, { id: id, ref: ref, href: "#" + mainId, onClick: handleClick, className: classnames_1.default(block({ styled: !unstyled }), className) }), children));
});
if (process.env.NODE_ENV !== "production") {
    try {
...
exports.default = SkipToMainContent;
