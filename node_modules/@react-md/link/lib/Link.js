...
var block = utils_1.bem("rmd-link");
/**
 ...
 * `linkComponent` prop.
 */
var Link = react_1.forwardRef(function Link(_a, ref) {
    ...
    var className = classnames_1.default(block({ "flex-centered": flexCentered }), propClassName);
    var rel = propRel;
