...
@mixin rmd-thead {
  @if $rmd-table-cell-height != $rmd-table-header-cell-height {
    @include rmd-table-theme-update-var(cell-height, $rmd-table-header-cell-height);
  }
  ...
  @if $rmd-table-cell-dense-height != $rmd-table-header-cell-dense-height {
    ...
    .rmd-table--dense & {
      @include rmd-table-theme-update-var(cell-height, $rmd-table-header-cell-dense-height);
    }
  }
}
...
@mixin rmd-table-cell {
  ...
  &--header {
    @if $rmd-table-cell-color != $rmd-table-header-cell-color {
      @include rmd-table-theme-update-var(cell-color, $rmd-table-header-cell-color);
    }
    @include rmd-typography-value(subtitle-2, font-weight, letter-spacing, line-height);
    @include rmd-utils-rtl {
      text-align: right;
    }
  ...
  &--checkbox {
    @include rmd-table-theme-update-var(cell-h-padding, $rmd-table-checkbox-padding);
  }
