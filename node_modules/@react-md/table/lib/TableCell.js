...
var TableCellContent_1 = __importDefault(require("./TableCellContent"));
var block = utils_1.bem("rmd-table-cell");
/**
 ...
 * readers.
 */
var TableCell = react_1.forwardRef(function TableCell(_a, ref) {
    var _b;
    ...
    var sortIcon = icon_1.useIcon("sort", propSortIcon);
    ...
    var _e = config_1.useTableConfig({
        hAlign: propHAlign,
        vAlign: propVAlign,
    ...
    var footer = footer_1.useTableFooter();
    var sticky = sticky_1.useSticky(propSticky);
    ...
    return (react_1.default.createElement(Component, __assign({}, props, { ref: ref, id: id, "aria-sort": sortOrder === "none" ? undefined : sortOrder, colSpan: colSpan, className: classnames_1.default(block((_b = {
                grow: grow,
                header: header,
                sticky: sticky,
        ...
        react_1.default.createElement(TableCellContent_1.default, { id: id ? id + "-sort" : undefined, icon: sortIcon, iconAfter: sortIconAfter, sortOrder: sortOrder, rotated: sortIconRotated }, children)));
});
