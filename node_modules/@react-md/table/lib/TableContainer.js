 ...
 */
var TableContainer = react_1.forwardRef(function TableContainer(_a, ref) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, className: classnames_1.default("rmd-table-container", className) }), children));
});
