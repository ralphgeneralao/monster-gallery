 ...
 */
var TableCellContent = react_1.forwardRef(function TableCellContent(_a, ref) {
    ...
    return (react_1.default.createElement(button_1.UnstyledButton, { id: id, ref: ref, style: style, className: classnames_1.default(block("child"), className) },
...
exports.default = TableCellContent;
