...
var block = utils_1.bem("rmd-table");
/**
 ...
 */
var Table = react_1.forwardRef(function Table(_a, ref) {
    ...
    return (react_1.default.createElement(config_1.TableConfigProvider, { value: configuration },
        react_1.default.createElement("table", __assign({}, props, { ref: ref, className: classnames_1.default(block({
                dense: dense,
