...
export default function useItemVisibility({ horizontal, onClick: propOnClick, onKeyDown: propOnKeyDown, defaultVisible, defaultFocus: propDefaultFocus, onVisibilityChange, }?: ItemVisibilityOptions): ReturnValue;
export {};
