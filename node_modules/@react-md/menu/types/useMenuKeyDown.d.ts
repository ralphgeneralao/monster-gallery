 ...
 */
export default function useMenuKeyDown({ menu, onKeyDown, onRequestClose, portalled, horizontal, defaultFocus, }: MenuKeyDownOptions): React.KeyboardEventHandler<HTMLDivElement>;
export {};
