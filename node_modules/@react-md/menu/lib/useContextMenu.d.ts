...
declare type ReturnValue<CE extends HTMLElement> = [ProvidedContextMenuProps, React.MouseEventHandler<CE>, VisibilityDispatcher];
interface Options {
    /**
...
export default function useContextMenu<CE extends HTMLElement>({ id, ref: propRef, anchor, classNames, disableDeselect, }?: Options): ReturnValue<CE>;
export {};
