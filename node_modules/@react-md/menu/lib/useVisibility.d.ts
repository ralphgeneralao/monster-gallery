export declare type FocusType = "first" | "last";
 ...
 * @private
 */
export default function useVisibility({ defaultVisible, defaultFocus: defaultFocusValue, onVisibilityChange, }?: VisibilityOptions): ReturnValue;
export {};
