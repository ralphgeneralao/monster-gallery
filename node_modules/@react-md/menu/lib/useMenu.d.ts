 ...
 */
export default function useMenu({ ref, visible, controlId, horizontal, onClick: propOnClick, onKeyDown: propOnKeyDown, portalled, defaultFocus, onRequestClose, disableControlClickOkay, }: MenuOptions): ReturnValue;
export {};
