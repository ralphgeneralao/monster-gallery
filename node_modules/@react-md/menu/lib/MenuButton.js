...
var ToggleChildren_1 = __importDefault(require("./ToggleChildren"));
var block = utils_1.bem("rmd-menu-button");
/**
 ...
 */
var MenuButton = react_1.forwardRef(function MenuButton(_a, ref) {
    var _b;
    ...
    return (react_1.default.createElement(button_1.Button, __assign({}, props, { ref: ref, "aria-haspopup": ariaHasPopup, "aria-expanded": visible ? "true" : undefined, className: classnames_1.default(block(), (_b = {},
            _b[actionClassName] = first || last || inheritColor || asAppBarAction,
            _b), className) }),
        react_1.default.createElement(ToggleChildren_1.default, { visible: visible, dropdownIcon: dropdownIcon, disableDropdownIcon: disableDropdownIcon || buttonType === "icon" }, children)));
});
