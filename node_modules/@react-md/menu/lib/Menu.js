...
var MenuEvents_1 = __importDefault(require("./MenuEvents"));
var Orientation_1 = require("./Orientation");
var useMenu_1 = __importDefault(require("./useMenu"));
 ...
 * when needed, etc.
 */
var Menu = react_1.forwardRef(function Menu(_a, forwardedRef) {
    ...
    return (react_1.default.createElement(transition_1.ScaleTransition, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId, appear: mountOnEnter, visible: visible, classNames: classNames, timeout: timeout, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit },
        react_1.default.createElement(Orientation_1.OrientationProvider, { orientation: orientation },
            react_1.default.createElement("div", __assign({}, props, { "aria-orientation": orientation, ref: ref, role: role, tabIndex: tabIndex, style: style, className: classnames_1.default(block({ horizontal: horizontal }), className), onClick: onClick, onKeyDown: onKeyDown }),
                children,
                react_1.default.createElement(MenuEvents_1.default, { menuRef: menuRef, cancelled: cancelled, defaultFocus: defaultFocus })))));
});
