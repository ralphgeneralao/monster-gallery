...
var Grid = react_1.forwardRef(function Grid(_a, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: ref, style: mergedStyle, className: classnames_1.default(block({ "no-padding": padding === 0 }), className) }), content));
});
