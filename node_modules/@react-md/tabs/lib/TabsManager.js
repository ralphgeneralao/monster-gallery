...
function TabsManager(_a) {
    ...
    var _e = react_1.useState(defaultActiveIndex), localActiveIndex = _e[0], setActiveIndex = _e[1];
    var handleActiveIndexChange = react_1.useCallback(function (activeIndex) {
    ...
    var value = react_1.useMemo(function () { return ({
        ...
        tabs: tabs.map(function (config, i) {
            var tab;
            if (typeof config === "string" || react_1.isValidElement(config)) {
                tab = { children: config };
            }
            else {
                tab = config;
