 ...
 */
var Tab = react_1.forwardRef(function Tab(_a, ref) {
    ...
    return (react_1.default.createElement("button", __assign({}, props, handlers, { ref: ref, "aria-selected": active, "aria-controls": panelId, type: "button", role: "tab", disabled: disabled, className: classnames_1.default(block({ active: active, stacked: icon && stacked }), className), tabIndex: active ? undefined : -1 }),
