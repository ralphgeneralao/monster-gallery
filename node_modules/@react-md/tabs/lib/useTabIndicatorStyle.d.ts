...
declare type ReturnValue = [CSSProperties, MergedTabRef, MutableRefObject<HTMLDivElement | null>];
/**
 ...
 * @private
 */
export default function useTabIndicatorStyle({ style, ref, align, itemRefs, totalTabs, activeIndex, }: Options): ReturnValue;
export {};
