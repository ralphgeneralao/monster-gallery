...
var useTabIndicatorStyle_1 = __importDefault(require("./useTabIndicatorStyle"));
...
var TabsList = react_1.forwardRef(function TabsList(_a, forwardedRef) {
    ...
    var _j = useTabIndicatorStyle_1.default({
        ...
        activeIndex: activeIndex,
    }), mergedStyle = _j[0], ref = _j[1], tabsRef = _j[2];
    ...
    return (react_1.default.createElement("div", __assign({}, props, { "aria-orientation": orientation, style: mergedStyle, role: "tablist", className: classnames_1.default(block((_b = {},
            _b[align] = true,
            _b.padded = padded,
            _b.vertical = !horizontal,
            _b.animate = !disableTransition && (!automatic || !isKeyboard),
            _b)), className), ref: ref, onClick: handleClick, onKeyDown: handleKeyDown }), react_1.Children.map(tabs, function (child, i) {
