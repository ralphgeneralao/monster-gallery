...
import { MergableHandlers, TooltipInitiated } from "./useHandlers";
 ...
 */
export declare function useOtherInteractionDisable(initiated: TooltipInitiated, hideTooltip: () => void): void;
export interface TooltipStateOptions extends MergableHandlers, Pick<TooltipProps, "position">, Pick<VisibilityChangeOptions, "onShow" | "onHide"> {
    /**
