...
exports.useTouchState = exports.useKeyboardState = exports.useMouseState = void 0;
...
function useMouseState(_a) {
    ...
    var handlers = utils_1.useRefCache({ onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave });
    var isHoverModeable = useTooltipHoverMode_1.useTooltipHoverModeEnabled();
    if (typeof disableHoverMode === "boolean") {
        isHoverModeable = !disableHoverMode;
    }
    var delay = useTooltipHoverMode_1.useTooltipHoverModeDelay();
    if (!isHoverModeable) {
        delay = propDelay;
    }
    var hoverModeActions = useTooltipHoverMode_1.useTooltipHoverModeActions();
    var _b = utils_1.useTimeout(function () {
...
function useKeyboardState(_a) {
    ...
    var handlers = utils_1.useRefCache({ onFocus: onFocus, onBlur: onBlur, onKeyDown: onKeyDown });
    var isWindowBlurred = react_1.useRef(false);
    var _b = utils_1.useTimeout(function () {
...
function useTouchState(_a) {
    ...
    var touched = react_1.useRef(false);
    var handlers = utils_1.useRefCache({ onTouchStart: onTouchStart, onTouchMove: onTouchMove, onContextMenu: onContextMenu });
    var _b = utils_1.useTimeout(function () {
