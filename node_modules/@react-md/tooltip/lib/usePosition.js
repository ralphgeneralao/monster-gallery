...
function usePosition(_a) {
    ...
    var _b = react_1.useState(defaultPosition), position = _b[0], setPosition = _b[1];
    var prevPosition = utils_1.useRefCache(position);
    /**
     ...
     */
    var setEstimatedPosition = react_1.useCallback(function (container) {
