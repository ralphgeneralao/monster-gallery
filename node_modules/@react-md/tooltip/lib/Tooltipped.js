...
function Tooltipped(_a) {
    ...
    var _r = useTooltipState_1.default({
    ...
    var tooltip = (react_1.default.createElement(portal_1.ConditionalPortal, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId },
        react_1.default.createElement(Tooltip_1.default, __assign({ id: tooltipId }, props, { dense: dense, position: position, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit, style: style, onEnter: function (node, appear) {
                if (onEnter) {
                    onEnter(node, appear);
                }
