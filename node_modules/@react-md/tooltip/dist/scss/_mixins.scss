...
@mixin rmd-tooltip-dense-theme {
  @include rmd-tooltip-theme-update-var(font-size, rmd-tooltip-theme-var(dense-font-size));
  @include rmd-tooltip-theme-update-var(line-height, rmd-tooltip-theme-var(dense-line-height));
  @include rmd-tooltip-theme-update-var(min-height, rmd-tooltip-theme-var(dense-min-height));
  ...
  @include rmd-tooltip-theme-update-var(spacing, rmd-tooltip-theme-var(dense-spacing));
}
...
@mixin rmd-tooltip {
  ...
  &--above {
    transform: translateY(rmd-utils-negate-var(rmd-tooltip-theme-var(transition-distance)));
  }
  ...
  &--left {
    transform: translateX(rmd-utils-negate-var(rmd-tooltip-theme-var(transition-distance)));
  }
