...
var LayoutMain = react_1.forwardRef(function LayoutMain(_a, forwardedRef) {
    ...
    var _f = LayoutProvider_1.useLayoutConfig(), layout = _f.layout, visible = _f.visible;
    ...
    var _g = transition_1.useCSSTransition({
        ref: forwardedRef,
    ...
    return (react_1.default.createElement(Component, __assign({}, props, { ref: ref, tabIndex: tabIndex, className: classnames_1.default(styles({ "header-offset": headerOffset }), className) })));
});
