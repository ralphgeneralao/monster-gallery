 ...
 */
export default function useLayoutNavigation<T extends BaseTreeItem = LayoutNavigationItem>(navItems: LayoutNavigationTree<T>, pathname: string, linkComponent?: ElementType): LayoutNavigationState<T>;
