...
var styles = utils_1.bem("rmd-layout-title");
/**
 ...
 */
var LayoutAppBarTitle = react_1.forwardRef(function LayoutAppBarTitle(_a, ref) {
    var propId = _a.id, className = _a.className, children = _a.children, props = __rest(_a, ["id", "className", "children"]);
    var _b = LayoutProvider_1.useLayoutConfig(), baseId = _b.baseId, layout = _b.layout;
    var id = propId !== null && propId !== void 0 ? propId : baseId + "-title";
    return (react_1.default.createElement(app_bar_1.AppBarTitle, __assign({}, props, { id: id, ref: ref, className: classnames_1.default(styles({ offset: utils_2.isFullHeightLayout(layout) }), className) }), children));
});
...
exports.default = LayoutAppBarTitle;
