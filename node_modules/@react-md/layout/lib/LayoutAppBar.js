...
var LayoutAppBarTitle_1 = __importDefault(require("./LayoutAppBarTitle"));
var LayoutNavToggle_1 = __importDefault(require("./LayoutNavToggle"));
 ...
 */
var LayoutAppBar = react_1.forwardRef(function LayoutAppBar(_a, ref) {
    ...
    var _c = LayoutProvider_1.useLayoutConfig(), baseId = _c.baseId, layout = _c.layout;
    ...
    if (typeof nav === "undefined") {
        ...
        nav = react_1.default.createElement(LayoutNavToggle_1.default, __assign({ key: layout }, navToggleProps));
    }
    var title = customTitle;
    if (typeof title === "undefined") {
        title = (react_1.default.createElement(LayoutAppBarTitle_1.default, __assign({}, titleProps), titleChildren));
    }
