...
@mixin rmd-layout-theme($property, $theme-style: $property, $fallback: null) {
  @include rmd-theme-apply-rmd-var($property, $theme-style, $rmd-layout-theme-values, layout);
}
...
@mixin rmd-layout-theme-update-var($theme-style, $value) {
  @include rmd-theme-update-rmd-var($value, $theme-style, $rmd-layout-theme-values, layout);
}
...
@mixin react-md-layout {
  ...
  .rmd-layout-title {
    &--offset {
      $margin: calc(#{rmd-sheet-theme-var(static-width)} + #{$rmd-app-bar-keyline});
  ...
  .rmd-layout-nav-toggle {
    &--offset {
      ...
      $distance: calc(#{$rmd-app-bar-title-nav-margin} + #{$nav-size} - #{$icon-size});

      @include rmd-utils-rtl-auto(margin-right, $distance, $rmd-app-bar-lr-margin);
    }
  }
