...
import { LayoutConfiguration, LayoutNavigationItem, LayoutWithTitle } from "./types";
/**
...
export interface LayoutProps<T extends BaseTreeItem = LayoutNavigationItem> extends LayoutConfiguration, FlattenedLayoutComponentConfiguration<T> {
    /**
